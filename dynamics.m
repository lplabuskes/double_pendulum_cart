...
mass_matrix = [m_c+2*m_p, -2*m_p*l*cos(theta1), -m_p*l*cos(theta2);
               -2*m_p*l*cos(theta1), 2*m_p*l^2, m_p*l^2*cos(theta1-theta2);
               -m_p*l*cos(theta2), m_p*l^2*cos(theta1-theta2), m_p*l^2];

rhs = [u - 2*m_p*l*theta1dot^2*sin(theta1) - m_p*l*theta2dot^2*sin(theta2);
       2*m_p*g*l*sin(theta1) - m_p*l^2*theta2dot^2*sin(theta1-theta2);
       m_p*g*l*sin(theta2) + m_p*l^2*theta1dot^2*sin(theta1-theta2)];
